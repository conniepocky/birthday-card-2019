...
return (new CustomEvent(event_name,(function (){var obj30210 = {"detail":data};
return obj30210;
})()));
} else {
...
var f = (function (){var pred__30217 = cljs.core._EQ_;
var expr__30218 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__30217.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__30218))){
return ((function (pred__30217,expr__30218){
return (function (p1__30211_SHARP_){
return console.warn(p1__30211_SHARP_);
});
;})(pred__30217,expr__30218))
} else {
if(cljs.core.truth_(pred__30217.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__30218))){
return ((function (pred__30217,expr__30218){
return (function (p1__30212_SHARP_){
return console.debug(p1__30212_SHARP_);
});
;})(pred__30217,expr__30218))
} else {
if(cljs.core.truth_(pred__30217.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__30218))){
return ((function (pred__30217,expr__30218){
return (function (p1__30213_SHARP_){
return console.error(p1__30213_SHARP_);
});
;})(pred__30217,expr__30218))
} else {
return ((function (pred__30217,expr__30218){
return (function (p1__30214_SHARP_){
return console.log(p1__30214_SHARP_);
});
;})(pred__30217,expr__30218))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__30221){
...
return new_def.callback(p1__30224_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__30226,(0),null);
var v = cljs.core.nth.call(null,vec__30226,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1549663082903
