...
var G__25737 = cljs.core.first.call(null,element_str);
switch (G__25737) {
case "?":
arr.push((1));
...
var G__25739 = cljs.core.next.call(null,items);
items = G__25739;
continue;
} else {
return null;
...
var G__25742 = cljs.core.next.call(null,cljs.core.next.call(null,items));
items = G__25742;
continue;
} else {
return true;
...
switch (G__25745) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_.call(null,path,((function (G__25745){
return (function (p1__25743_SHARP_){
return cljs.core.not_EQ_.call(null,p1__25743_SHARP_,(2));
});})(G__25745))
))){
...
return cljs.core.not_EQ_.call(null,p1__25744_SHARP_,(1));
});})(G__25745))
))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__25745)].join('')));

}
}
});

//# sourceMappingURL=schema.js.map?rel=1549663079512
