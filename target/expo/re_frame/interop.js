...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__23496 = cljs.core.instance_QMARK_;
var expr__23497 = reactive_val;
if(cljs.core.truth_(pred__23496.call(null,reagent.ratom.RAtom,expr__23497))){
return "ra";
} else {
if(cljs.core.truth_(pred__23496.call(null,reagent.ratom.RCursor,expr__23497))){
return "rc";
} else {
if(cljs.core.truth_(pred__23496.call(null,reagent.ratom.Reaction,expr__23497))){
return "rx";
} else {
if(cljs.core.truth_(pred__23496.call(null,reagent.ratom.Track,expr__23497))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1549663076341
