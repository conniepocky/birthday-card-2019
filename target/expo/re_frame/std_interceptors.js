...
var vec__24973_24976 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_24977 = cljs.core.nth.call(null,vec__24973_24976,(0),null);
var only_after_24978 = cljs.core.nth.call(null,vec__24973_24976,(1),null);
var db_changed_QMARK__24979 = ((!((only_before_24977 == null))) || (!((only_after_24978 == null))));
if(db_changed_QMARK__24979){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_24977);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_24978);
...
var map__24980 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__24980__$1 = ((((!((map__24980 == null)))?(((((map__24980.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__24980.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__24980):map__24980);
var db = cljs.core.get.call(null,map__24980__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__24980__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__24982 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__24982__$1 = ((((!((map__24982 == null)))?(((((map__24982.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__24982.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__24982):map__24982);
var coeffects = map__24982__$1;
var event = cljs.core.get.call(null,map__24982__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
/** @this {Function} */
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq24984){
var self__4487__auto__ = this;
return self__4487__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq24984));
});
...
return cljs.core.get_in.call(null,new_db,p1__24988_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__24989_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__24989_SHARP_);
...
/** @this {Function} */
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq24990){
...
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24991,G__24992,seq24990__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1549663078676
