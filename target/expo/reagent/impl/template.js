...
var G__23375 = o;
(G__23375[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__23377__i < G__23377__a.length) {G__23377__a[G__23377__i] = arguments[G__23377__i + 0]; ++G__23377__i;}
  args = new cljs.core.IndexedSeq(G__23377__a,0,null);
} 
...
var G__23381 = jsprops;
(G__23381["defaultValue"] = value);

(G__23381["onChange"] = ((function (G__23381,v,value,on_change){
return (function (p1__23380_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__23380_SHARP_);
});})(G__23381,v,value,on_change))
);
...
var vec__23384 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__23384,(0),null);
var id = cljs.core.nth.call(null,vec__23384,(1),null);
var class$ = cljs.core.nth.call(null,vec__23384,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___23388 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___23388 == null)){
} else {
var key_23389 = temp__5461__auto___23388;
(jsprops["key"] = key_23389);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__23390 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__23390["name"] = c);
...
var len__4499__auto___23395 = arguments.length;
var i__4500__auto___23396 = (0);
while(true){
if((i__4500__auto___23396 < len__4499__auto___23395)){
args__4502__auto__.push((arguments[i__4500__auto___23396]));

var G__23397 = (i__4500__auto___23396 + (1));
i__4500__auto___23396 = G__23397;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq23393){
var G__23394 = cljs.core.first.call(null,seq23393);
var seq23393__$1 = cljs.core.next.call(null,seq23393);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23394,seq23393__$1);
});
...
break;
default:
var G__23400 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__23400;
continue;
...
var n__4376__auto___23402 = a.length;
var i_23403 = (0);
while(true){
if((i_23403 < n__4376__auto___23402)){
(a[i_23403] = reagent.impl.template.as_element.call(null,(a[i_23403])));
...
var a = cljs.core.into_array.call(null,s);
var n__4376__auto___23405 = a.length;
var i_23406 = (0);
while(true){
if((i_23406 < n__4376__auto___23405)){
var val_23407 = (a[i_23406]);
if(((cljs.core.vector_QMARK_.call(null,val_23407)) && ((reagent.impl.template.key_from_vec.call(null,val_23407) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_23406] = reagent.impl.template.as_element.call(null,val_23407));

var G__23408 = (i_23406 + (1));
i_23406 = G__23408;
continue;
} else {
}
...
var ctx = ({});
var vec__23409 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__23409,(0),null);
var derefed = cljs.core.nth.call(null,vec__23409,(1),null);
...
var G__23412 = (cljs.core.count.call(null,argv) - first_child);
switch (G__23412) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__23412){
...
//# sourceMappingURL=template.js.map?rel=1549663076124
